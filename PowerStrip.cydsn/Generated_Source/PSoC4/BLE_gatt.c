    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    /* Device Name */
    (uint8)'C', (uint8)'Y', (uint8)'B', (uint8)'L', (uint8)'E',
    ...
    (uint8)'R', (uint8)'l', (uint8)'y', (uint8)'1', (uint8)' ', (uint8)'u', (uint8)'i', (uint8)'n', (uint8)'t',
    (uint8)'8',
    ...
    /* Characteristic User Description */
    (uint8)'R', (uint8)'l', (uint8)'y', (uint8)'2', (uint8)' ', (uint8)'u', (uint8)'i', (uint8)'n', (uint8)'t',
    (uint8)'8',
...
const uint8 cyBle_attUuid128[][16u] = {
    /* PowerStrip */
    { 0xFDu, 0x70u, 0x6Eu, 0x10u, 0xF5u, 0x16u, 0xDBu, 0xA0u, 0xABu, 0x4Eu, 0x8Du, 0x42u, 0x15u, 0x64u, 0x4Eu, 0x98u },
    /* Relay_1 */
    { 0xA0u, 0x64u, 0x12u, 0xEDu, 0xBFu, 0x57u, 0xA4u, 0xADu, 0xF8u, 0x4Cu, 0x04u, 0xEAu, 0xA8u, 0x10u, 0xE3u, 0x52u },
    /* Relay_2 */
    { 0x8Bu, 0xFCu, 0x9Bu, 0xA0u, 0x77u, 0x51u, 0x40u, 0xA6u, 0x2Au, 0x46u, 0x9Bu, 0x88u, 0x99u, 0x4Fu, 0x23u, 0x56u },
};
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0010u, (void *)&cyBle_attUuid128[0] }, /* PowerStrip UUID */
    { 0x0010u, (void *)&cyBle_attUuid128[1] }, /* Relay_1 UUID */
    { 0x0001u, (void *)&cyBle_attValues[21] }, /* Relay_1 */
    { 0x000Au, (void *)&cyBle_attValues[22] }, /* Characteristic User Description */
    { 0x0010u, (void *)&cyBle_attUuid128[2] }, /* Relay_2 UUID */
    { 0x0001u, (void *)&cyBle_attValues[32] }, /* Relay_2 */
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x16u] = {
    ...
    { 0x0012u, 0x10A8u /* Relay_1                             */, 0x090A0101u /* rd,wr */, 0x0013u, {{0x0001u, (void *)&cyBle_attValuesLen[9]}} },
    ...
    { 0x0015u, 0x4F99u /* Relay_2                             */, 0x090A0101u /* rd,wr */, 0x0016u, {{0x0001u, (void *)&cyBle_attValuesLen[12]}} },
