...
#define CYBLE_POWERSTRIP_SERVICE_INDEX   (0x00u) /* Index of PowerStrip service in the cyBle_customs array */
#define CYBLE_POWERSTRIP_RELAY_1_CHAR_INDEX   (0x00u) /* Index of Relay_1 characteristic */
#define CYBLE_POWERSTRIP_RELAY_1_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CYBLE_POWERSTRIP_RELAY_2_CHAR_INDEX   (0x01u) /* Index of Relay_2 characteristic */
#define CYBLE_POWERSTRIP_RELAY_2_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */


#define CYBLE_POWERSTRIP_SERVICE_HANDLE   (0x0010u) /* Handle of PowerStrip service */
#define CYBLE_POWERSTRIP_RELAY_1_DECL_HANDLE   (0x0011u) /* Handle of Relay_1 characteristic declaration */
#define CYBLE_POWERSTRIP_RELAY_1_CHAR_HANDLE   (0x0012u) /* Handle of Relay_1 characteristic */
#define CYBLE_POWERSTRIP_RELAY_1_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0013u) /* Handle of Characteristic User Description descriptor */
#define CYBLE_POWERSTRIP_RELAY_2_DECL_HANDLE   (0x0014u) /* Handle of Relay_2 characteristic declaration */
#define CYBLE_POWERSTRIP_RELAY_2_CHAR_HANDLE   (0x0015u) /* Handle of Relay_2 characteristic */
#define CYBLE_POWERSTRIP_RELAY_2_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0016u) /* Handle of Characteristic User Description descriptor */
