...
const CYBLE_CUSTOMS_T cyBle_customs[0x01u] = {
    ...
    /* PowerStrip service */
    {
        0x0010u, /* Handle of the PowerStrip service */ 
        {

            /* Relay_1 characteristic */
            {
                0x0012u, /* Handle of the Relay_1 characteristic */ 
            ...
            /* Relay_2 characteristic */
            {
                0x0015u, /* Handle of the Relay_2 characteristic */ 
